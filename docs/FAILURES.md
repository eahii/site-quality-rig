...
| F45 | 2026-09-01 | "Eleven distinct blindings of the comparator are now each caught by a named leg" was written as if a clone could re-derive the eleven; they are itemised only in a review transcript this repo does not contain, and the sentence carried no as-of — the exact labelling rule every other unreproducible number here follows | annotation-overclaim | independent review | LOW (a) | `docs/VERIFICATION.md` "The 2026-09-01 pass — six increments, graded cold"; `docs/EVIDENCE.md` "Whether the battery says the same thing twice" |
| F46 | 2026-09-01 | The Quickstart's known-miss timing figure carried no as-of of its own and inherited a date by sitting next to the controls line, while its receipt is stamped over a disclosed-dirty tree | annotation-overclaim | independent review | LOW (a) | `docs/VERIFICATION.md` "The 2026-09-01 pass — six increments, graded cold" |
